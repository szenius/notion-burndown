  ...
  /******/ var __webpack_modules__ = {
        ...
        constructor(options) {
            ...
            children: {
              ...
              append: (args) => {
                return this.request({
                  ...
                  query: helpers_1.pick(
                    args,
                    api_endpoints_1.blocksChildrenAppend.queryParams
                  ),
                  body: helpers_1.pick(
                    args,
                    api_endpoints_1.blocksChildrenAppend.bodyParams
                  ),
              ...
              list: (args) => {
                return this.request({
                  ...
                  query: helpers_1.pick(
                    args,
                    api_endpoints_1.blocksChildrenList.queryParams
                  ),
                  body: helpers_1.pick(
                    args,
                    api_endpoints_1.blocksChildrenList.bodyParams
                  ),
                  auth: args === null || args === void 0 ? void 0 : args.auth,
                });
              },
          ...
          this.databases = {
            ...
            retrieve: (args) => {
              return this.request({
                ...
                query: helpers_1.pick(
                  args,
                  api_endpoints_1.databasesRetrieve.queryParams
                ),
                body: helpers_1.pick(
                  args,
          ...
          __classPrivateFieldSet(
            ...
            (_b =
              ...
              ? _b
              : logging_1.makeConsoleLogger(this.constructor.name),
            "f"
          );
          const prefixUrl =
            ((_c =
          ...
          const notionVersion =
            (_e =
              options === null || options === void 0
                ? void 0
                : options.notionVersion) !== null && _e !== void 0
              ? _e
    ...
    /***/ 8259: /***/ (
      ...
      function isAPIErrorCode(code) {
        return (
          typeof code === "string" && Object.values(APIErrorCode).includes(code)
        );
      }
    ...
    /***/ 2725: /***/ (
      ...
      ChartJSImage.prototype.toDataURI = function () {
        ...
        return this.toBuffer().then(
          (buffer) =>
            `data:${mimetype};${encoding},${buffer.toString(encoding)}`
        );
      };
